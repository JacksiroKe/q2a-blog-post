...
*/
	...
	return array(
		...
		'cat_4' => 'Category 4:',
		'cat_5' => 'Category 5:',
		'blog_title' => 'Blog Title - HTML allowed:',
		'blog_tagline' => 'Blog Tagline - HTML allowed:',
		'content_max' => 'Maximum length of preview:',
		'suffix' => 'characters',
		...
		'posts_null' => 'Sorry there are currently no blog posts here yet. Get things started by being the first to post here!',
		 ...
		 // Articles page
		'articles_page' => 'Post a new article',
		...
		'access_error' => 'Sorry, you are currently unable to post on our blog. Please ^1log in^2 or ^3register^4 to blog!',
