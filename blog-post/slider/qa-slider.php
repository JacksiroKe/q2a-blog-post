...
function SliderTop()  {
	return '<script type="text/javascript" src="'.qa_path_to_root().'qa-plugin/blog-post/slider/jquery-1.9.1.min.js"></script>
			<script type="text/javascript" src="'.qa_path_to_root().'qa-plugin/blog-post/slider/jssor.core.js"></script>
			<script type="text/javascript" src="'.qa_path_to_root().'qa-plugin/blog-post/slider/jssor.utils.js"></script>
			<script type="text/javascript" src="'.qa_path_to_root().'qa-plugin/blog-post/slider/jssor.slider.js"></script>
			<script>
    ...
    <div class="slider" style="position: relative; border-radius:5px;overflow: hidden;margin: 10px; padding: 12px;">
        <div style="position: relative; left: 50%;border-radius:5px; width: 5000px; text-align: center; margin-left: -2500px;">
            <div id="slider1_container" style="position: relative; margin: 0 auto;
                top: 0px; left: 0px; max-width: 950px; border-radius:5px; height: 400px;">
                <!-- Loading Screen -->
...
function ContentSlider($title,$postid,$link,$author,$date,$type,$content)  {
	return '<div>
			<div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;
					...
					<br />
					<a href="'.$link.'">
						<img src="'.qa_path_to_root().'qa-plugin/blog-post/slider/more.png" border="0" alt="auction slider" width="215"
							height="50" /></a>
				</div>
				<img src="'.get_image($content).'" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />
				<img u="thumb" src="'.get_image($content).'" />
			</div>';
			}
