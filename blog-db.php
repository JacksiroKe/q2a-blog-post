...
function bp_db_post_update($postid, $title, $permalink, $content, $format, $tagstring, $catid, $notify, $lastuserid = null, $lastip = null, $name = null)
{
...
function bp_db_post_hide($postid, $type, $lastuserid = null, $lastip = null)
{
	if (isset($lastuserid) || isset($lastip)) {
		qa_db_query_sub(
...
function bp_db_post_delete($postid)
{
	qa_db_query_sub('DELETE FROM ^blog_posts WHERE postid=#', $postid);
}
